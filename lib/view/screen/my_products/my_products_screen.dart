...
import 'package:el_biz/view/screen/my_products/widgets/my_products_widget.dart';
...
class _MyProductsScreenState extends State<MyProductsScreen> {
  ...
  void initState() {
    ...
    _scrollController.addListener(() {
      ...
      final publicProductBloc = context.read<MyProductsBloc>();
      ...
      if (_scrollController.position.pixels >=
        ...
        if (publicProductBloc.state.currentPage < pageSize) {
          ...
          publicProductBloc.add(GetMyProducts(page: nextPage + 1));
        }
      }
    });
  }
                      ...
                      Expanded(
                        child: productController.isGridView
                            ? GridView.builder(
                                ...
                                itemCount: publicState.myProducts.length,
                                itemBuilder: (context, index) {
                                  // return SizedBox();
                                  return ProductGridItem(
                                    isSelectProduct: widget.isSelectProduct,
                                    product: publicState.myProducts[index],
