...
class ProductReviewsScreen extends StatelessWidget {
  ...
  void _callScrolling(BuildContext context, ScrollController scrollController) {
    final accountController = context.read<ProductReviewBloc>();
    ...
    scrollController.addListener(() {
      if (scrollController.position.pixels >=
        ...
        if (accountController.state.currentPage < pageSize) {
          ...
          accountController.add(GetProductReviews(productId, nextPage + 1));
        }
      }
    });
  }
                              ...
                              children: [
                                Column(
                                  children: [
                                    ...
                                    Text(
                                      '${state.productReviewsModel.data?.totalReviews} отзывов',
                                      style: body14.copyWith(
                      ...
                      Expanded(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            final data = state.productReviewsModel.data;
                  ...
                  ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      return ProductReviewItemWidget(
                        review: state.productReviews[index],
                        reviewIndex: index,
                      );
                    },
                  ),
