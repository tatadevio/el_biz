...
class CompanyAuctions extends StatelessWidget {
  ...
  const CompanyAuctions({super.key, required this.scrollController});
      ...
      return BlocBuilder<CompanyBloc, CompanyState>(
        ...
        return Column(
          children: [
                ...
                Expanded(
                  child: InkWell(
                    onTap: () {
                      context
                          .read<CompanyBloc>()
                          .add(const UpdateShowAuctions(true));
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        border: Border(
                          bottom: BorderSide(
                              width: companyState.isShowActiveAuctions ? 2 : 1,
                              color: companyState.isShowActiveAuctions
                                  ? ColorResources.blue
                ...
                Expanded(
                  child: InkWell(
                    onTap: () {
                      context
                          .read<CompanyBloc>()
                          .add(const UpdateShowAuctions(false));
              ...
              child: Row(
                ...
                children: [
                  CustomGridviewWidget(
                    isSelected: companyState.isShowAuctionsGridView,
                    onTap: () {
                      context
                          .read<CompanyBloc>()
            ...
            if (companyState.isShowActiveAuctions)
              CompanyActiveAuctionsWidget(
                scrollController: scrollController,
              ),
            if (!companyState.isShowActiveAuctions)
              CompanyInActiveAuctionsWidget(
                scrollController: scrollController,
              ),
          ],
        );
