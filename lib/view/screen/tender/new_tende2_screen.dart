...
class _NewTende2ScreenState extends State<NewTende2Screen> {
  ...
  loadTenderData() async {
    ...
    context.read<AddTenderBloc>().add(UpdateTenderImages(tenderData.media!));
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (widget.isEdit)
                              if (addTenderState
                                          .addTenderModel?.uploadedImages !=
                                      null &&
                                  addTenderState.addTenderModel!.uploadedImages!
                                      .isNotEmpty) ...[
                                Wrap(
                                  spacing: 8,
                                  runSpacing: 8,
                                  children: addTenderState
                                      .addTenderModel!.uploadedImages!
                                      .map(
                                        (image) => Stack(
                                          children: [
                              ...
                              onTap: () {
                                ...
                                Get.to(() => SelectCategoryScreen(
                                      ...
                                      onSelect: (selectedCategories) {
                                        context.read<AddTenderBloc>().add(
                                            SelectCategory(
