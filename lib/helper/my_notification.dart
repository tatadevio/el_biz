...
// import '../view/screen/chat/chat_conversation.dart';
...
//     var iOSInitialize = const IOSInitializationSettings(requestBadgePermission: true, requestAlertPermission: true, requestSoundPermission: true, defaultPresentAlert: true, defaultPresentBadge: true, defaultPresentSound: true);
...
//         _reciverId = message.data['senderId']; // replace there receiverId with senderId
...
//           _image = (message.notification?.android?.imageUrl != null) ? message.notification?.android?.imageUrl : null;
//         } else if (GetPlatform.isIOS) {
//           _image = (message.notification?.apple?.imageUrl != null) ? message.notification?.apple?.imageUrl : null;
//         }
//       }
...
//         try {
//           await showBigPictureNotificationHiddenLargeIcon(_title, _body, _orderID, _image, _type, _reciverId, fln);
//         } catch (e) {
//           await showBigTextNotification(_title, _body, _orderID == null ? "0" : _orderID, _type == null ? "normal" : _type, _reciverId ?? "", fln);
//         }
//       } else {
//         await showBigTextNotification(_title, _body, _orderID == null ? "0" : _orderID, _type == null ? "normal" : _type, _reciverId ?? "", fln);
//       }
...
//   static Future<void> showBigTextNotification(String? title, String? body, String orderID, String type, String receiverId, FlutterLocalNotificationsPlugin fln) async {
...
//       fullScreenIntent: true, // Important for showing notifications in locked screen
//       playSound: true,
//       icon: '@drawable/notification_icon',
//       sound: const RawResourceAndroidNotificationSound('notification'),
//     );
//     NotificationDetails platformChannelSpecifics = NotificationDetails(android: androidPlatformChannelSpecifics);
//     await fln.show(0, title, body, platformChannelSpecifics, payload: orderID + "," + type + "," + receiverId);
//   }
...
//     await fln.show(0, _title, _body, platformChannelSpecifics, payload: _orderID + "," + _type);
//   }

//   static Future<void> showBigPictureNotificationHiddenLargeIcon(String? title, String? body, String? orderID, String image, String? type, String? receiverId, FlutterLocalNotificationsPlugin fln) async {
