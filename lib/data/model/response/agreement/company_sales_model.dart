...
//
//     final companySalesModel = companySalesModelFromJson(jsonString);

import 'dart:convert';

CompanySalesModel companySalesModelFromJson(String str) =>
    CompanySalesModel.fromJson(json.decode(str));

String companySalesModelToJson(CompanySalesModel data) =>
...
class CompanySalesModel {
  ...
  factory CompanySalesModel.fromJson(Map<String, dynamic> json) =>
      CompanySalesModel(
...
class Data {
  final List<CompanyContractItem>? items;
  ...
  Data copyWith({
    List<CompanyContractItem>? items,
    int? totalPages,
    int? currentPage,
    int? total,
    int? perPage,
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        items: json["items"] == null
            ? []
            : List<CompanyContractItem>.from(
                json["items"]!.map((x) => CompanyContractItem.fromJson(x))),
